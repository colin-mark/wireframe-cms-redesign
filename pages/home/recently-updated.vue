      ...
      <div class="border-2 border-dashed border-astra-gray-400 rounded-lg p-12 text-center bg-astra-gray-25">
        <div class="space-y-4">
          <div class="w-16 h-16 bg-astra-blue rounded-lg flex items-center justify-center mx-auto">
            <DocumentArrowDownIcon class="w-8 h-8 text-astra-white" />
          </div>
          <h2 class="text-xl font-medium text-astra-gray-700">Recently Updated</h2>
          <p class="text-astra-gray-600 max-w-md mx-auto">
            View and manage recently updated content, pages, and website changes for quick access and review.
          </p>
        </div>
      </div>
    </div>

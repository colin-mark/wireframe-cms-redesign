    ...
    <div class="max-w-6xl mx-auto">
      <div class="border-2 border-dashed border-astra-gray-400 rounded-lg p-12 text-center bg-astra-gray-25">
        <div class="space-y-4">
          ...
          <h2 class="text-xl font-medium text-astra-gray-700">Contact Form Notifications</h2>
          <p class="text-astra-gray-600 max-w-md mx-auto">
            Manage notification rules and recipients for each of your contact form workflows.
          </p>
        </div>
      </div>
    </div>
